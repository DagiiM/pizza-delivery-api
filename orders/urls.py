...
urlpatterns = [
    ...
    path('users/<int:user_id>/orders/',views.UserOrdersView.as_view(),name='user_orders'),
    path('users/<int:user_id>/orders/<int:order_id>/',views.UserOrderDetail.as_view(),name='user_order_detail'),
]
